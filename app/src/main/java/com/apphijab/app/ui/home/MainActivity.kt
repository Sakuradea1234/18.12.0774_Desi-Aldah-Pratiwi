package com.apphijab.app.ui.home
...
import com.apphijab.app.databinding.ActivityMainBinding
import com.apphijab.app.ui.auth.ApphijabAuth
import com.apphijab.app.ui.auth.AuthActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun init() {
        binding.bottomNavav.setOnNavigationItemSelectedListener {
            when(it.itemId) {
